...
if($query):
  echo "<script>alert('commentaire soumis avec succès. Le commentaire sera affiché après l'examen de l'administrateur');</script>";
...
<html lang="en">
  ...
  <head>
    ...
    <title>Portail de nouvelles | Page d'accueil</title>
...
<p>
          ...
          <b>Posté par </b> <?php echo htmlentities($row['postedBy']);?> sur </b><?php echo htmlentities($row['postingdate']);?> |
          <?php if($row['lastUpdatedBy']!=''):?>
          <b>Dernière mise à jour par </b> <?php echo htmlentities($row['lastUpdatedBy']);?> sur </b><?php echo htmlentities($row['UpdationDate']);?></p>
        <?php endif;?>
                <p><strong>Partager:</strong> <a href="http://www.facebook.com/share.php?u=<?php echo $currenturl;?>" target="_blank">Facebook</a> | 
...
<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $currenturl;?>" target="_blank">Linkedin</a>  <b>Visites:</b> <?php print $visits; ?>
                </p>
                <hr />
...
<input type="text" name="name" class="form-control" placeholder="Entrez votre nom complet" required>
</div>

 <div class="form-group">
 <input type="email" name="email" class="form-control" placeholder="Entrez votre email valide" required>
 </div>


                <div class="form-group">
                  <textarea class="form-control" name="comment" rows="3" placeholder="Commentaire" required></textarea>
                </div>
...
<div class="media mb-4">
            ...
            <div class="media-body">
              <h5 class="mt-0"><?php echo htmlentities($row['name']);?> <br />
                  <span style="font-size:11px;"><b>à</b> <?php echo htmlentities($row['postingDate']);?></span>
            </h5>
