  <div class="col-md-4">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Rechercher...." required>
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Nouvelles récentes</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
...
?>
  ...
  <li>
   ...
   <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Nouvelles populaires</h5>
            <div class="card-body">
                      <ul >
<?php
