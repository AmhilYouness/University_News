...
<html lang="en">
  ...
  <head>
    ...
    <title>Portail de nouvelles | Page de catégorie</title>
...
?>
<h1><?php echo htmlentities($row['category']);?> Nouvelles</h1>
          <div class="card mb-4">
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
              <h2 class="card-title"><?php echo htmlentities($row['posttitle']);?></h2>
           
              <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-primary">En savoir plus &rarr;</a>
            </div>
            <div class="card-footer text-muted">
            Posté sur <?php echo htmlentities($row['postingdate']);?>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        ...
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" class="page-link">Précédent</a>
        </li>
